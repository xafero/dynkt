 ...
 * ContextClassloader for finding resources need to use this wrapper and
 * the @link OSGiScriptFactory. Mainly, jruby does.
 * 
 ...
 * Caveats:
 * <ul>
 * <li>All factories are wrapped with an {@link OSGiScriptEngineFactory}. As
 * Engines are not wrapped, calls like <code>
 ...
 * </code> might result in unexpected errors. Future versions may wrap the
 * ScriptEngine with a OSGiScriptEngine to solve this issue, but for the moment
 * it is not needed.</li>
 * 
 */
public class OSGiScriptEngineManager extends ScriptEngineManager {
	 ...
	 * you want to clean the bindings you can either get a fresh instance of
	 ...
	 * the same bindings are applied to all the underlying managers.
	 * 
	 * @param bindings
	 */
